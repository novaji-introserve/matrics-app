...
class Theme(models.TransientModel):
    ...
    def onchange_name(self):
        theme = self.sudo().env.ref('custom_backend_theme.theme_data_stored')
        if theme:
    ...
    def action_apply(self):
        ...
        if name == 'two':
            self.env.ref('custom_backend_theme.vista_theme_css_black').active = False
            self.env.ref('custom_backend_theme.vista_theme_css_login_black').active = False
            self.env.ref('custom_backend_theme.vista_theme_css_green').active = True
            self.env.ref('custom_backend_theme.vista_theme_css_login_green').active = True
            self.icon_change_theme_green()
        elif name == 'three':
            self.env.ref('custom_backend_theme.vista_theme_css_green').active = False
            self.env.ref('custom_backend_theme.vista_theme_css_login_green').active = False
            self.env.ref('custom_backend_theme.vista_theme_css_black').active = True
            self.env.ref('custom_backend_theme.vista_theme_css_login_black').active = True
    ...
    def icon_change_theme_default(self):
        ...
        for menu in menu_item:
            ...
            if menu.name == 'Case Management':
                img_path = get_module_resource(
                    'custom_backend_theme', 'static', 'src', 'img', 'icons',
                    'case_management.png')
                menu.write({'web_icon_data': base64.b64encode(
                    open(img_path, "rb").read())})
            if menu.name == 'Alert Managment':
                img_path = get_module_resource(
                    'custom_backend_theme', 'static', 'src', 'img', 'icons',
                    'alert.png')
                menu.write({'web_icon_data': base64.b64encode(
