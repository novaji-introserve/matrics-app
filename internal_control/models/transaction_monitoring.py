...
class TransactionMonitoring(models.Model):
    ...
    trancurrency = fields.Char(string="Transaction Currency", readonly=True)
    crossrate = fields.Char(string="Cross Rate", readonly=True)
    charge = fields.Char(string="Charge", readonly=True)
    reversal = fields.Char(string="Reversal Flag", readonly=True)
    accountmodule = fields.Char(string="Account Module", readonly=True)
    chknum = fields.Char(string="Check Number", readonly=True)
    ...
    tran_channel = fields.Char(string="Transaction Channel", readonly=True)
    ...
    overideid = fields.Char(string="Override ID", readonly=True)
