...
logger = logging.getLogger("__CUSTOMER_DIGITAL_PRODUCT__")
config_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'configs', 'customer_digital_product.json')
